...
delta3 = a3 - Y;
delta2 = (delta3*Theta2 .* sigmoidGradient([ones(size(z2,1), 1) z2]))(:,2:end); % 2:end is taken bcoz we generally dont consider bias unit in the calculations as mentioned in the video  
